...
# Based and improved implementation, inspired by:
# github.com/circulosmeos/bitcoin-in-tiny-pieces/blob/master/bitcoin-get-address-balance.py

# Developed by: ~geniusprodigy
# edited by Zwilla 2023
# I have implemented and modified so that it is possible to automatically check list-based
# Bitcoin Addresses to work with massive volumes of scans.
import sys
import re
...
def check_balance(check_address):
...
print("__________________________________________________\n")
print("Developed by: ~geniusprodigy edited by zwilla")
...
arq1 = open('addresses-with-balance-yay.txt', 'a')
arq1.write("\nDeveloped by: ~geniusprodigy. If this saved you time or helped, donations please for "
           "BTC Address: 1FrRd4iZRMU8i2Pbffzkac5u4KwUptmc7S")
arq1.close()
